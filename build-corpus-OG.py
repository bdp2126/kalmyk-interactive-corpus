...
<body class="bg-gray-50 text-gray-900 font-sans">
    ...
    <div class="max-w-7xl mx-auto px-4 py-8" x-data="corpusApp()">
        ...
        <header class="mb-8 border-b pb-6 border-gray-200">
            <h1 class="text-4xl font-extrabold text-indigo-950">Interactive Kalmyk Corpus</h1>
            <p class="text-gray-600 mt-2">Browse, search, and filter annotations generated from Praat TextGrids.</p>
        </header>
